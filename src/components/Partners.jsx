...
const Partners = () => {
    return (
        <div className="partners-degrade py-6 md:py-16" id="Partners">
            <div className="bg-[#AF92FE] flex flex-col md:flex-row items-start px-5 md:px-32 py-8 md:py-12">
                <div className="flex-1 text-left mb-6 md:mb-0">
                    <h2 className="text-4xl md:text-5xl font-bold text-gray-900">Partners</h2>
                    <h3 className="text-2xl md:text-2xl tracking-wide text-violet-100 mt-2">Ellos confían en nosotros.</h3>
                </div>
