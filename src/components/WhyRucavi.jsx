        ...
        <div className="px-0 md:px-2 md:px-16 pt-8 pb-6 why-degrade" id="JoinUs">
            <div className="flex flex-col lg:flex-row flex-wrap md:flex-nowrap items-start md:gap-40 mx-2 md:ml-12 md:mb-10">
                <div className="flex-1 text-left relative">
                    ...
                    <div className="relative inline-block z-10 -mt-[5.2rem] md:-mt-[7.15rem] flex justify-center items-center h-full">
                ...
                <div className="flex-1 relative -mt-8 md:mt-5">
                    <div className="flex justify-end">
                        <h3 className="Subtitle text-[clamp(0.81rem, 1vw + 0.5rem, 0.975rem)] md:text-[1.88rem] font-medium md:mb-0.5 mb-0 text-[#7C50FF] pt-4 md:pt-0 mr-3 md:mr-[7.6rem]">
                    ...
                    <div className="mb-4 text-[0.9rem] md:text-[1.65rem] text-[#EAE4FE] font-[350] leading-[1.05] mt-6 md:mt-8 px-4 md:pr-24 pl-8">
                        <img src={WhiteArrowIcon} className="absolute left-[0.6rem] top-[4.5rem] md:-left-[2.2rem] md:top-[7.4rem] md:h-5 h-3 md:w-5 w-3" />
            ...
            <div className="mt-12 md:mt-0 ml-4">
                ...
                <ul className="grid grid-cols-2 gap-x-8 md:flex md:flex-nowrap list-none text-left mx-6 md:mx-4 text-[0.75rem] md:text-xl text-[#5B24FD] leading-9 px-0 md:px-[5.7rem] justify-center md:justify-between">
            ...
            <hr className="mt-4 md:mt-10 mb-3 md:mb-6 ml-[2.5rem] md:ml-[7.8rem] mr-[1.4rem] md:mx-[7rem] md:mr-[6.6rem] border-[#E9E5FE]" />
