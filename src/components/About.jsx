...
function About() {
    ...
    return (
        <div className="BiggerAboutContainer overflow-hidden relative sm:pt-[60px] pl-1 sm:pl-14 -mt-32 sm:-mt-20" id="AboutUs" ref={containerRef}>
            <div ref={lineRef} className="AboutDivider sticky top-[7.8rem] md:top-[9rem] lg:top-[10.5rem] left-0 w-[calc(21.5rem*3)] lg:w-[calc(48.5rem*3)] h-0.5 bg-gray-500 ml-6 md:ml-10 lg:ml-44"></div>

            <div className="AboutContainer flex pt-16 pb-10 md:py-14 lg:py-20 md:px-10 lg:px-44 w-full space-x-4 sm:space-x-80">
                <section className="sections py-4 px-5 sm:px-0 mx-0 sm:mx-0 min-w-[100vw] md:min-w-[35rem]" ref={(el) => (sectionsRef.current[0] = el)}>
                    ...
                    <div className="TextContainer1 text-[#9471FF] mt-12">
                        ...
                        <p className="AboutText mb-4 text-sm md:text-xl">Nos consideramos un socio estratégico en el camino hacia el éxito tecnológico, integrando a nuestros colaboradores en cada etapa del proceso.</p>
                        <p className="AboutText mb-4 text-sm md:text-xl">
                ...
                <section className="sections py-4 px-5 sm:px-0 mx-6 sm:mx-0 min-w-[100vw] md:min-w-[35rem]" ref={(el) => (sectionsRef.current[1] = el)}>
                    ...
                    <div className="TextContainer2 text-[#9471FF] mt-12 -mb-7">
                        ...
                        <p className="AboutText mb-4 text-sm md:text-xl">Nuestro equipo, formado por profesionales comprometidos, combina la experiencia y el conocimiento para abordar los desafíos de nuestros clientes con confianza y diligencia.</p>
                        <p className="AboutText mb-4 text-sm md:text-xl">En RUCAVI nos enorgullece contar con un equipo que prioriza la satisfacción del cliente y la excelencia en cada proyecto que emprendemos.</p>
                    </div>
                    <SmallButton>EQUIPO</SmallButton>
                    <img src={VioletArrowIcon} className="VioletArrow absolute -left-[6rem] md:left-[32.9rem] top-[28.5rem] md:top-[37.8rem] h-12 w-12" />
                </section>
                <section className="sections py-4 px-5 sm:px-0 mx-0 sm:mx-0 min-w-[100vw] md:min-w-[35rem]" ref={(el) => (sectionsRef.current[2] = el)}>
                    ...
                    <div className="TextContainer3 text-[#9471FF] mt-12 sm:-mb-7">
                        ...
                        <p className="AboutText mb-4 text-sm md:text-xl">En RUCAVI, cada proyecto es una oportunidad para demostrar nuestra dedicación a la innovación y la excelencia.</p>
                    </div>
