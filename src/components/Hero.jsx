...
function Hero() {
    ...
    return (
        <div className='px-4 sm:px-8 pt-[4.8rem] sm:pt-[4.8rem] pb-4 hero-degrade' id='Home'>
            <div className="relative h-screen">
                <img
                    src="src/assets/Gray-bg4.webp"
                    className="bg-cover absolute top-0 left-0 w-full h-[85%] sm:h-[90%] object-cover rounded-tr-3xl rounded-tl-3xl rounded-bl-3xl rounded-br-7xl"
                    alt="Gray Background"
                />
                <header className="relative z-10 flex flex-col items-left p-4 sm:p-[5.2rem]">
                ...
                <section className='relative z-10 flex flex-col tracking-wide py-12 sm:py-24 pl-4 sm:pl-24 mt-64 sm:mt-0'>
                    <h2 className='text-xl sm:text-3xl font-normal text-violet-100 fade-in fade-in-delay-2'>¿Buscas <span className='font-bold'>soluciones</span> de alto</h2>
                    <h2 className='text-xl sm:text-3xl font-normal text-violet-100 fade-in fade-in-delay-2'>impacto para tu negocio?</h2>
                </section>
                ...
                <div onClick={(e) => handleSmoothScroll(e, '#AboutUs')} className="Arrow absolute bottom-[6.4rem] sm:bottom-[7.2rem] right-0 z-10 hover:cursor-pointer">
                    <svg
